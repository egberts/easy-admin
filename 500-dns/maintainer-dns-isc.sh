...
INSTANCE_RNDC_KEY_FILENAME="${RNDC_KEY_FILEPART}-${INSTANCE}${RNDC_KEY_FILETYPE}"
...
INSTANCE_RNDC_CONF_FILENAME="${INSTANCE_SUBDIRPATH}${RNDC_CONF_FILENAME}"
...
INSTANCE_RNDC_KEY_FILESPEC="${INSTANCE_RNDC_KEY_DIRSPEC}/$INSTANCE_RNDC_KEY_FILENAME"
